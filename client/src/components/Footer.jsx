          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row">
              <input
                ...
                className="w-full sm:w-3/4 px-4 py-3 text-gray-800 border border-gray-400 rounded-l-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60 placeholder-gray-400 mb-4 sm:mb-0"
              />
              <button className="w-full sm:w-1/3 bg-blue-600 text-white py-3 rounded-r-xl hover:bg-blue-700 transition duration-300 ease-in-out cursor-pointer">
                Subscribe
              </button>
            </div>
          </div>
